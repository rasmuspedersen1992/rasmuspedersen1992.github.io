...
function draw() {
  ...
  //   		lattice[x][y].neighbours[k].display();
	...
	text("Lower energy: "+nfc(TotAccepted/TotNumMoves,4),10,40);
	text("Monte carlo: "+nfc(TotMonteCarloAccepted/TotNumMoves,4),10,55);
	text("Rejected: "+nfc(TotRejected/TotNumMoves,4),10,70);
